      ...
      if (isset($categories_fill)) {
          ...
          if ($categories_fill == 'none') {
              ...
              for ($i = $startLang; $i < $stopLang; $i++) {
                  if (! isset($languages[$i]['id'])) { //otherwise it is an invlaid ID
                      continue;
                  }
          ...
          <td width="55%"><table border="2" width="100%">
           <tr>
            <td><table border="0" width="100%">
             ...
             <tr class="smallText">          
              <td title="<?php echo $filltagsPopup['skipall']; ?>" class="popup"><INPUT TYPE="radio" NAME="group1" VALUE="none" <?php echo (isset($checkedCats['none']) ? $checkedCats['none'] : ''); ?>> <?php echo HEADING_TITLE_SEO_SKIPALL; ?></td>
              <td title="<?php echo $filltagsPopup['skipall']; ?>" class="popup"><INPUT TYPE="radio" NAME="group2" VALUE="none" <?php echo (isset($checkedManuf['none']) ? $checkedManuf['none'] : ''); ?>> <?php echo HEADING_TITLE_SEO_SKIPALL; ?></td>
              <td title="<?php echo $filltagsPopup['skipall']; ?>" class="popup"><INPUT TYPE="radio" NAME="group3" VALUE="none" <?php echo (isset($checkedProds['none']) ? $checkedProds['none'] : ''); ?>> <?php echo HEADING_TITLE_SEO_SKIPALL; ?></td>
             </tr>
             <tr class="smallText"> 
              <td title="<?php echo $filltagsPopup['empty']; ?>"><INPUT TYPE="radio" NAME="group1" VALUE="empty" <?php echo (isset($checkedCats['empty']) ? $checkedCats['empty'] : ''); ?> > <?php echo HEADING_TITLE_SEO_FILLONLY; ?></td>
              <td title="<?php echo $filltagsPopup['empty']; ?>"><INPUT TYPE="radio" NAME="group2" VALUE="empty" <?php echo (isset($checkedManuf['empty']) ? $checkedManuf['empty'] : ''); ?>> <?php echo HEADING_TITLE_SEO_FILLONLY; ?></td>
              <td title="<?php echo $filltagsPopup['empty']; ?>"><INPUT TYPE="radio" NAME="group3" VALUE="empty" <?php echo (isset($checkedProds['empty']) ? $checkedProds['empty'] : ''); ?>> <?php echo HEADING_TITLE_SEO_FILLONLY; ?></td>
             </tr>
             <tr class="smallText"> 
              <td title="<?php echo $filltagsPopup['full']; ?>"><INPUT TYPE="radio" NAME="group1" VALUE="full" <?php echo (isset($checkedCats['full']) ? $checkedCats['full'] : ''); ?>> <?php echo HEADING_TITLE_SEO_FILLALL; ?></td>
              <td title="<?php echo $filltagsPopup['full']; ?>"><INPUT TYPE="radio" NAME="group2" VALUE="full" <?php echo (isset($checkedManuf['full']) ? $checkedManuf['full'] : ''); ?>> <?php echo HEADING_TITLE_SEO_FILLALL; ?></td>
              <td title="<?php echo $filltagsPopup['full']; ?>"><INPUT TYPE="radio" NAME="group3" VALUE="full" <?php echo (isset($checkedProds['full']) ? $checkedProds['full'] : ''); ?>> <?php echo HEADING_TITLE_SEO_FILLALL; ?></td>
             </tr>
             <tr class="smallText"> 
              <td title="<?php echo $filltagsPopup['clear']; ?>"><INPUT TYPE="radio" NAME="group1" VALUE="clear" <?php echo (isset($checkedCats['clear']) ? $checkedCats['clear'] : ''); ?>> <?php echo HEADING_TITLE_SEO_CLEARALL; ?></td>
              <td title="<?php echo $filltagsPopup['clear']; ?>"><INPUT TYPE="radio" NAME="group2" VALUE="clear" <?php echo (isset($checkedManuf['clear']) ? $checkedManuf['clear'] : ''); ?>> <?php echo HEADING_TITLE_SEO_CLEARALL; ?></td>
              <td title="<?php echo $filltagsPopup['clear']; ?>"><INPUT TYPE="radio" NAME="group3" VALUE="clear" <?php echo (isset($checkedProds['clear']) ? $checkedProds['clear'] : ''); ?>> <?php echo HEADING_TITLE_SEO_CLEARALL; ?></td>
             </tr>
            </table></td>         
           </tr> 
           <tr>
