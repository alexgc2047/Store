...
*/
  ...
  if (file_exists(DIR_WS_FUNCTIONS . 'version_checker.php'))
  {
      ...
      $currentVersion = 'Header Tags SEO V 3.2.9';
                     ...
                     <tr>            
                      <td><table border="0" width="100%" id="<?php echo $id_toggle; ?>" style="display: <?php echo (($id_toggle == $showMetaInfoItem) ? 'inline' : 'none'); ?>">
                       <tr class="smallText" style="background: <?php echo (tep_not_null($shopsMetaInfo['title']) ? yellow : red) ?>;">
                        <td  title="<?php echo $commonPopup['view_title_A']; ?>" class="popup"width="10%" style="font-weight: bold;"><?php echo HEADING_TITLE_SEO_TITLE; ?></td>
                        <td  title="<?php echo $commonPopup['view_title_B']; ?>" class="popup"><input type="text" name="title_viewed" value="<?php echo $shopsMetaInfo['title']; ?>" maxlength="255" size="65" id="title_<?php echo $id_toggle; ?>_viewed"> </td>
                       </tr> 
                       <tr class="smallText" style="background: <?php echo (tep_not_null($shopsMetaInfo['description'][1]) ? yellow : red) ?>;">
                        <td title="<?php echo $commonPopup['view_desc_A']; ?>" class="popup"style="font-weight: bold;"><?php echo HEADING_TITLE_SEO_DESCRIPTION; ?></td>
                        <td title="<?php echo $commonPopup['view_desc_B']; ?>" class="popup"><input type="text" name="desc_viewed" value="<?php echo $shopsMetaInfo['description']; ?>" maxlength="255" size="65" id="desc_<?php echo $id_toggle; ?>_viewed"> </td>
                       </tr> 
                       <tr class="smallText" style="background: <?php echo (tep_not_null($shopsMetaInfo['keywords'][1]) ? yellow : red) ?>;">
                        <td title="<?php echo $commonPopup['view_keywords_A']; ?>" class="popup"style="font-weight: bold;"><?php echo HEADING_TITLE_SEO_KEYWORDS; ?></td>
                        <td title="<?php echo $commonPopup['view_keywords_B']; ?>" class="popup"><input type="text" name="keyword_viewed" value="<?php echo $shopsMetaInfo['keywords']; ?>" maxlength="255" size="65" id="keyword_<?php echo $id_toggle; ?>_viewed"> </td>
                       <tr>
                      </table></td>
                     </tr>                    
                    </table></td>
