...
define('HEADING_DELIVERY_ADDRESS', 'Addresse de livraison');
...
define('HEADING_BILLING_ADDRESS', 'Addresse facturation');
define('HEADING_PAYMENT_METHOD', 'M&eacute;thode de paiement');

define('HEADING_ORDER_HISTORY', 'Historique commande');
...
define ('PDF_INVOICE','Facture PDF');
define ('PDF_DOWNLOAD_LINK','Si vous souhaitez voir / imprimer la version pdf de cette facture, cliquez <a title="Cliquez ici pour voir / imprimer une version pdf de cette facture" href="%s">ici</a>');
