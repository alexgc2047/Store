...
define ('PDF_DOWNLOAD_LINK','Si desea ver / imprimir una versión en PDF de este recibo, haga <a title="Click here to view / print a pdf version of this invoice" href="%s">Clic aquí</a>');
