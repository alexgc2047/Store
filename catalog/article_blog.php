        ...
        <tr>
          <td width="100%"><table border="0" cellpadding="2" width="100%">
            <tr>
              ...
              <td class="smallText" align="right"><?php echo tep_draw_hidden_field('article_name', $articles_name) . tep_image_submit('button_submit.gif', IMAGE_BUTTON_SUBMITCONTINUE, 'name="add_comment"'); ?></td>
            </tr>
          </table></td>
        </tr>
      </form>
